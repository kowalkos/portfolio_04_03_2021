...
class lab3_pierwszy
{
    ...
    public static double ciąg(int a,int b,int d)
    {
    ...
    public static double krzyżowanie_jedno(int   a ,int b,int d)
    {
        Random rand=new Random();
        int tab_1[]=new int[liczba_bitów(a, b, d)];
        int tab_2[]=new int[liczba_bitów(a, b, d)];
        int losowy_punkt=rand.nextInt(liczba_bitów(a, b, d)-1);
        ...
        System.out.println("Wartości funkcji dla rodziców i potomków");
        System.out.println( Funkcja(zamiana_deci(tab_1, a, b, d), zamiana_deci(tab_2, a, b, d)));
        System.out.println( Funkcja(zamiana_deci(tab_1_pot, a, b, d), zamiana_deci(tab_2_pot, a, b, d)));
        return Funkcja(zamiana_deci(tab_1_pot, a, b, d), zamiana_deci(tab_2_pot, a, b, d));
    }
    public static void krzyżowanie_wielo(int   a ,int b,int d,int ile)
    {
        Random rand=new Random();
        int tab_1[]=new int[liczba_bitów(a, b, d)];
        int tab_2[]=new int[liczba_bitów(a, b, d)];
    ...
    public static double zamiana_deci(int[] tab1,int a,int b,int d)
    {
        int mi=liczba_bitów(a, b, d);
    ...
    public static void main(String[] args) {
        //krzyżowanie_jedno(-2,2, 5); 
        krzyżowanie_wielo(-2, 2, 5, 3);
    }
}
